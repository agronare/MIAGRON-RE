...
function composeUbicacion(calleNumero, colonia, municipio, estado, cp) {
...
async function main() {
    ...
    const filePath = fileFromEnv
        ? path_1.default.resolve(fileFromEnv)
        : path_1.default.resolve(__dirname, '../../sucursales-copandaro.csv');
...
//# sourceMappingURL=import-sucursales.js.map